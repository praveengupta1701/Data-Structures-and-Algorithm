...
using namespace std::chrono;
 ...
 int findDuplicate(vector<int>& nums) //t(m)=0(n) and s(n)=O(n)
    ...
    // Why not Fast-Slow method work?  --> Because array is N sized not N+1 and one element is missing which not let us visit every index.
