...
//the function tries lock all lockable objects like mutex, sharable objects and other lockalbe object
//actual use of this is , it tries to lock multiple mutex at the same time try_lock(m1,m2,m3,m4)
